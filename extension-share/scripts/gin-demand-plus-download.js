...
XMLHttpRequest.prototype.send = function (body) {
  if (isListening && this._url && this._url.includes("/pre/pr05/getPr0502Chart")) {
...
function fetchDataAndDownloadExcel() {
  // 요청 감지 활성화
  isListening = true;
  //console.log("감지 시작: /pre/pr05/getPr0502Chart 요청을 기다립니다...");
  ...
  onRequestIntercepted = () => {
    fetch("https://aptgin.com/pre/pr05/getPr0502Chart", {
        headers: {
            "accept": "*/*",
